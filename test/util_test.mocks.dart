...
class MockStdout extends _i1.Mock implements _i2.Stdout {
  ...
  @override
  int get terminalColumns => (super.noSuchMethod(
        Invocation.getter(#terminalColumns),
        returnValue: 0,
      ) as int);
  @override
  int get terminalLines => (super.noSuchMethod(
  ...
  @override
  _i2.IOSink get nonBlocking => (super.noSuchMethod(
  ...
  @override
  set encoding(_i3.Encoding? encoding) => super.noSuchMethod(
        Invocation.setter(
          #encoding,
          encoding,
        ),
